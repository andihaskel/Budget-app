...
class EditFixed extends Component {
  constructor(props) {
    ...
    this.state = {categories: [], price: 0, categorySelected: '', title:'', payment: {}, monthly:true};
  }
  goBack() {
  ...
  editFixed() {
    ...
    this.props.navigator.immediatelyResetRouteStack([{id:this.props.previousWindow, initialPage:1}]);
  }
